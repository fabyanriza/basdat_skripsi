...
<div class="min-h-screen bg-gray-100 p-6 flex">
    ...
    <div class="flex-1 ml-6">
        ...
        <div class="grid grid-cols-2 gap-6">
            <!-- Data Mahasiswa -->
            <a href="#" class="bg-gradient-to-r from-blue-500 to-indigo-500 text-white p-6 rounded-lg shadow-md">
                <h4 class="text-lg font-bold">Data Mahasiswa</h4>
            </a>

            <!--Jadwal Bimbingan -->
            <a href="#" class="bg-gradient-to-r from-purple-500 to-pink-500 text-white p-6 rounded-lg shadow-md">
                <h4 class="text-lg font-bold">Jadwal Bimbingan</h4>
            </a>

            <!--Laporan Bimbingan -->
            <a href="#" class="bg-gradient-to-r from-blue-500 to-indigo-500 text-white p-6 rounded-lg shadow-md">
                <h4 class="text-lg font-bold">Laporan Bimbingan</h4>
            </a>

            <!--Persetujuan Pengajuan Skripsi -->
            <a href="#" class="bg-gradient-to-r from-purple-500 to-pink-500 text-white p-6 rounded-lg shadow-md">
                <h4 class="text-lg font-bold">Persetujuan Pengajuan Skripsi</h4>
            </a>

            <!--Monitoring Skripsi Mahasiswa -->
            <a href="#" class="bg-gradient-to-r from-blue-500 to-indigo-500 text-white p-6 rounded-lg shadow-md">
                <h4 class="text-lg font-bold">Monitoring Skripsi Mahasiswa</h4>
            </a>
