...
<head>
  ...
  <title>Persetujuan Pengajuan Seminar Proposal</title>
</head>
...
<div class="min-h-screen flex">
    ...
    <div class="flex-1 p-6">
      ...
      <div class="flex justify-between items-center bg-white p-6 rounded-lg shadow-md">
        <h1 class="text-2xl font-bold">Persetujuan Pengajuan Seminar Proposal</h1>
        <div class="w-12 h-12 rounded-full bg-gray-300"></div>
      </div>

      <!-- Persetujuan Pengajuan Seminar Proposal Table -->
      <div class="my-6">
        ...
        <table class="w-full bg-purple-200 rounded-lg text-left">
          <thead class="bg-purple-500 text-white">
            <tr>
              ...
              <th class="p-4">Berkas Persyaratan</th>
          ...
          <tbody>
            <tr class="bg-white">
              ...
              <td class="p-4">
                <button class="bg-gray-300 text-black px-4 py-2 rounded-md">Lihat Berkas</button>
              </td>
              <td class="p-4">
                <span class="bg-green-500 text-white px-2 py-1 rounded-md">ACC</span>
                <span class="bg-red-500 text-white px-2 py-1 rounded-md">Decline</span>
              </td>
            </tr>
            <tr class="bg-white">
