        ...
        <table class="w-full bg-purple-200 rounded-lg text-left">
          ...
          <tbody>
            <tr class="bg-white">
              ...
              <td class="p-4">10.00 - 12.00</td>
              <td class="p-4">R.07</td>
            </tr>
            <tr class="bg-white">
              <td class="p-4">Fabyan Riza Kiram</td>
              <td class="p-4">Teknologi Sapi</td>
              <td class="p-4">3 Oktober 2024</td>
              <td class="p-4">13.00 - 15.00</td>
              <td class="p-4">R.02</td>
            </tr>
            <tr class="bg-white">
              ...
              <td class="p-4">R.01</td>
            </tr>
            <tr class="bg-white">
              <td class="p-4">Sinta Dian Monica</td>
              <td class="p-4">Sastra Mesin</td>
              <td class="p-4">4 Oktober 2024</td>
              <td class="p-4">09.00 - 11.00</td>
              <td class="p-4">R.08</td>
            </tr>
            <tr class="bg-white">
              <td class="p-4">Fabyan Riza Kiram</td>
              <td class="p-4">Teknologi Sapi</td>
