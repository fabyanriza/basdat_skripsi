...
<div class="min-h-screen flex">
  ...
  <div class="w-1/12 bg-purple-600 flex flex-col items-center py-10 space-y-8">
    ...
    <div class="flex-1 p-6">
        ...
        <table class="w-full bg-purple-200 rounded-lg text-left">
          <thead class="bg-purple-500 text-white">
            <tr>
              ...
              <th class="p-4">Waktu Bimbingan</th>
              <th class="p-4">Tanggapan Dosen</th>
          ...
          <tbody>
            <tr class="bg-white">
              ...
              <td class="p-4">
                <span class="bg-green-500 text-white p-2 rounded-md">ACC</span>
              </td>
              <td class="p-4"><span class="bg-yellow-500 text-white p-2 rounded-md">Menunggu</span></td>
            </tr>
            <tr class="bg-white">
              ...
              <td class="p-4"><span class="bg-green-500 text-white p-2 rounded-md">ACC</span></td>
              <td class="p-4"><span class="bg-yellow-500 text-white p-2 rounded-md">Menunggu</span></td>
            </tr>
            <tr class="bg-white">
              <td class="p-4">Taushiyah Virgi Eka Zahra</td>
              <td class="p-4">Kedokteran Pastry</td>
              <td class="p-4">12 September 2024</td>
              <td class="p-4">11.00 - 12.00</td>
              <td class="p-4"><span class="bg-green-500 text-white p-2 rounded-md">ACC</span></td>
              <td class="p-4"><span class="bg-yellow-500 text-white p-2 rounded-md">Menunggu</span></td>
            </tr>
      ...
      <!-- Arsip Bimbingan -->
      <div class="my-6">
        <h2 class="text-xl font-bold mb-4">Arsip Bimbingan</h2>
        <table class="w-full bg-purple-200 rounded-lg text-left">
          <thead class="bg-purple-500 text-white">
            <tr>
              <th class="p-4">Nama Mahasiswa</th>
          ...
          <tbody>
            <tr class="bg-white">
              ...
              <td class="p-4">10.00 - 11.00</td>
              <td class="p-4"><span class="bg-green-500 text-white p-2 rounded-md">ACC</span></td>
              <td class="p-4"><span class="bg-green-500 text-white p-2 rounded-md">Selesai</span></td>
            </tr>
            <tr class="bg-white">
              <td class="p-4">Fabyan Riza Kiram</td>
              <td class="p-4">Teknologi Sapi</td>
              <td class="p-4">1 September 2024</td>
              <td class="p-4">11.00 - 12.00</td>
              <td class="p-4"><span class="bg-red-500 text-white p-2 rounded-md">Decline</span></td>
              <td class="p-4"><span class="bg-yellow-500 text-white p-2 rounded-md">Jadwalkan Ulang</span></td>
            </tr>
            <tr class="bg-white">
              <td class="p-4">Taushiyah Virgi Eka Zahra</td>
              <td class="p-4">Kedokteran Pastry</td>
