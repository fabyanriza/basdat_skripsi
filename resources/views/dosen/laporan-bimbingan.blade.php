...
<div class="min-h-screen flex">
    ...
    <div class="flex-1 p-6">
      ...
      <div class="flex justify-between items-center bg-white p-6 rounded-lg shadow-md">
        <h1 class="text-2xl font-bold">Laporan Bimbingan</h1>
        <div class="w-12 h-12 rounded-full bg-gray-300"></div>
      </div>

      <!-- Laporan Bimbingan Table -->
      <div class="my-6">
        <h2 class="text-xl font-bold mb-4">Laporan Bimbingan</h2>
        <table class="w-full bg-purple-200 rounded-lg text-left">
          <thead class="bg-purple-500 text-white">
            <tr>
              ...
              <th class="p-4">BAB Bimbingan</th>
              <th class="p-4">Materi Bimbingan</th>
              <th class="p-4">Komponen Revisi</th>
          ...
          <tbody>
            <tr class="bg-white">
              ...
              <td class="p-4">
                Selama bimbingan seminar proposal, dosen tersebut sulit untuk ditemui dan dihubungi sehingga menyulitkan bimbingan.
              </td>
              <td class="p-4">
                Selama bimbingan seminar proposal, dosen tersebut sulit untuk ditemui dan dihubungi sehingga menyulitkan bimbingan.
              </td>
              <td class="p-4">
                <button class="bg-purple-500 text-white p-2 rounded-md">Edit</button>
              </td>
            </tr>
          </tbody>
        </table>
