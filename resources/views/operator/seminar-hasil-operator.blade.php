...
<div class="min-h-screen p-6 flex">
  <!-- Sidebar Kiri -->
  <div class="w-1/4">
        <div class="sidebar bg-white rounded-lg shadow-md border border-blue-400 P-4"> <!-- White background -->
    ...
    <div class="w-8/12 p-8">
      ...
      <div class="mb-4" style="margin-left: 20px;">
        <h1 class="text-2xl font-bold">Verifikasi Seminar Hasil</h1>
      </div>

      <!-- Table Section dengan Scroll Horizontal -->
      <div class="bg-white p-6 rounded-lg shadow-md overflow-x-auto whitespace-nowrap"style="margin-left: 20px;">
