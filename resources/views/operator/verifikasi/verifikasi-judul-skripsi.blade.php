        ...
        <div class="w-8/12 p-8">
            ...
            <div class="bg-purple-400 p-6 rounded-lg shadow-md">
                ...
                <div class="space-y-4">
                    <!-- Nama Mahasiswa -->
                    <div>
                        <label class="block font-bold text-white mb-2">Nama Mahasiswa</label>
                        <input type="text" value="Sinta Dian Monica" class="w-full p-2 rounded bg-gray-100" disabled />
                    </div>

                    <!-- Program Studi -->
                    <div>
                        <label class="block font-bold text-white mb-2">Program Studi</label>
                    ...
                    <!-- Dosen Pembimbing I -->
                    <div>
                        <label class="block font-bold text-white mb-2">Dosen Pembimbing I</label>
                        <select class="w-full p-2 rounded bg-gray-100">
                    ...
                    <!-- Dosen Pembimbing II -->
                    <div>
                        <label class="block font-bold text-white mb-2">Dosen Pembimbing II</label>
                        <select class="w-full p-2 rounded bg-gray-100">
                    ...
                    <!-- Dosen Penguji I -->
                    <div>
                        <label class="block font-bold text-white mb-2">Dosen Penguji I</label>
                        <select class="w-full p-2 rounded bg-gray-100">
                    ...
                    <!-- Tanggal Semhas -->
                    <div>
                        <label class="block font-bold text-white mb-2">Tanggal Semhas</label>
                        <select class="w-full p-2 rounded bg-gray-100">
                    ...
                    <!-- Waktu Semhas -->
                    <div>
                        <label class="block font-bold text-white mb-2">Waktu Semhas</label>
                        <select class="w-full p-2 rounded bg-gray-100">
                    ...
                    <!-- Ruangan -->
                    <div>
                        <label class="block font-bold text-white mb-2">Ruangan</label>
                        <select class="w-full p-2 rounded bg-gray-100">
                            <option>Ruang 6.09</option>
                            <option>Ruang 6.10</option>
                        </select>
                    </div>
