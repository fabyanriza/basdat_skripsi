...
<body class="bg-gray-100">
  ...
  <div class="min-h-screen flex">
    ...
    <div class="w-8/12 p-8">
      <!-- Header -->
      <div class="mb-8">
        <h1 class="text-2xl font-bold">Data Mahasiswa Pengajuan Judul</h1>
      </div>
        ...
        <table class="w-full table-auto">
          ...
          <tbody>
            ...
            <tr class="bg-white">
              ...
              <td class="p-4">Penelitian ini akan bertujuan untuk keselamatan karyawan di gedung tinggi...</td>
              <td class="p-4">
                <span class="bg-yellow-400 text-white px-4 py-2 rounded-full">Waiting</span>
              </td>
            </tr>
            <!-- row fabyan -->
            <tr class="bg-gray-100">
              ...
              <td class="p-4">Evaluasi Keuangan Bank Sejahtera</td>
              <td class="p-4">Penelitian ini akan bertujuan untuk meningkatkan keselamatan...</td>
              <td class="p-4">
                <span class="bg-green-500 text-white px-4 py-2 rounded-full">Accepted</span>
              </td>
            </tr>
            <!-- row kak tusi -->
            <tr class="bg-white-100">
              ...
              <td class="p-4">Penyuluhan ke Desa Penari</td>
              <td class="p-4">Penelitian ini akan bertujuan untuk menyebarkan budaya...</td>
              <td class="p-4">
                <span class="bg-red-500 text-white px-4 py-2 rounded-full">Rejected</span>
              </td>
            </tr>
